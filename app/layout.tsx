  ...
  return (
    <html lang="en" data-theme="dark">
      <body className={`${inter.variable} ${spaceGrotesk.variable} ${jetbrainsMono.variable} bg-page font-sans text-ink`}>
        ...
        <header className="sticky top-0 z-50 border-b-2 border-line/15 bg-page/90 backdrop-blur">
        ...
        <footer className="mt-16 border-t-2 border-line/15 bg-surface-dim">
          ...
          <div className="border-t border-line/10 px-4 py-4 text-center font-mono text-[0.68rem] uppercase tracking-[0.18em] text-ink/45 sm:px-6">
